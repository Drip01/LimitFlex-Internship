package internship.week9.DateTimeProject;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("May5 > toady? " + May5.isAfter(today));
        System.out.println("today > May5? " + May5.isBefore(today));
        System.out.println("May5 > toady? " + May5.compareTo(today));
        ...
        LocalTime sevenAM = LocalTime.of(7, 30, 0);
