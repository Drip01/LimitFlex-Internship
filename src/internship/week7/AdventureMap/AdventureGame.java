...
public class AdventureGame {
    ...
    private static final String GAME_LOCATIONS = """
            ...
            hill,on top of the hill with a view in the directions,N:forest, E:road
            well house,inside a well house for a small spring,W:road,N:lake,S:stream
            valley,in a forest valley beside a tumbling stream,N:road,W:hill,E:stream
            forest,at the edge of the edge of a thick dark forest,S:road,E:lake
    ...
    public AdventureGame(String customLocations) {
        ...
        if (customLocations != null) {
            loadDirections(customLocations);
        }
